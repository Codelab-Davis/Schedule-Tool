        ...
        return(
          ...
          <div class="page" id="normalscreen">
           <div class="row">
            ...
            <div className="row" style={{marginTop:"30px", marginLeft:"20px", justifyContent: "center"}}>
              <button type="button" className="btn btn-primary btn-sm col-2" style={{backgroundColor: "#162857", height:"30px", marginRight:"20px"}} onClick={this.onClickPrevRef}>Prev</button>
              <button type="button" className="btn btn-primary btn-sm col-2" style={{backgroundColor: "#162857",height:"30px", marginRight:"20px"}} onClick={this.onClickNextRef}>Next</button>
